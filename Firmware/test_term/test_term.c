...
testParams function_sin[] = {
    ...
    {{TERM_CONST_3, TERM_OP_MULT, TERM_OP_SIN, TERM_CONST_2, TERM_OP_BRACK_CLOSE, CHAR_END}, "3*sin(2)", 0, -1, 2.72789228},
    {{TERM_OP_SIN, TERM_OP_COS, TERM_CONST_2, TERM_OP_BRACK_CLOSE, TERM_OP_BRACK_CLOSE, CHAR_END}, "sin(cos(2))", 0, -1, -0.4042391538},
    {{TERM_OP_SIN, TERM_OP_COS, TERM_VAR_X, TERM_OP_BRACK_CLOSE, TERM_OP_POW, TERM_CONST_2, TERM_OP_BRACK_CLOSE, CHAR_END}, "sin(cos(x)^2)", 4, -1, 0.4143695580}
};
